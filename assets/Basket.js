export class Basket {
  ...
  #incrementArticle(article) {
    const articleElement = this.#domElems.find(e => e.id === article._id).elem;
    const quantityElement = articleElement.querySelector("p:nth-child(2) span:nth-child(2)");
  ...
  decrementArticle(article) {
    ...
    const quantityElement = articleElement.elem.querySelector("p:nth-child(2) span:nth-child(2)");
